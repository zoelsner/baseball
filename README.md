...
- **`sandlot_api.py` / `sandlot_cron.py`** — Sandlot V1 web app. Railway-ready FastAPI service with Postgres snapshots, manual refresh, scheduled Railway scrape, player detail sheets, MLB headshots/game logs/media, background profile warming, and cached Skipper takes. See [`docs/sandlot-railway-v1.md`](docs/sandlot-railway-v1.md).
